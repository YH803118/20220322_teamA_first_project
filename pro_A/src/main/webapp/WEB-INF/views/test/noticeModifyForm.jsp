...
<body>
	<h1> 글수정 페이지 </h1>
	<form action="/pro_A/test/noticeModify.do" method="post" enctype="multipart/form-data">
		<table class="tblView">
			<tr>
				<th>제목</th>
		...
		<a href="/pro_A/test/noticeDetail.do?noticeNo=${detailDTO.noticeNo }&pageNum=${pageNum }"><button type="button">취소</button></a>
	</form>
</body>
</html>